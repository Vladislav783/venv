...
while True:
    ...
    if stop_flag:
        break
#крч есть проблема с 0. Если сначала ввести 7 7 7, то будет 21 (например),
# а если потом ввести 0 0 0, то будет вновь 21. Пытлся и с if и break, но тогда
# оператор выполнения останавливается также как при вводе обычного слова или буквы...
